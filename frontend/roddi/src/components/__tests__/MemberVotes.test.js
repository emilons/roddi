...
it('renders correctly', () => {
  ...
  expect(
    RenderResult.container.getElementsByClassName('voteDivide')
  ).toBeDefined();
  expect(
    RenderResult.container.getElementsByClassName('voteDonate')
  ).toBeDefined();
  expect(
    RenderResult.container.getElementsByClassName('voteTrash')
  ).toBeDefined();
});
