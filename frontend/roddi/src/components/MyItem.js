    ...
    <div className="MyItem">
      <div className="estateNameAndItem">
        <div className="estateName">
          <a href="#/MyEstatePage" className="previousMI">
            &laquo; Tilbake
          </a>
        ...
        <div className="myVote">
          ...
          <div className="myUserPriority">
            <div className="myUserVotes" onChange={onChangeVote}>
              <div className="voteDivide">
                <input type="radio" value="divide" name="vote" />
              </div>
              <div className="voteDonate">
                <input type="radio" value="donate" name="vote" />
              </div>
              <div className="voteTrash">
                <input type="radio" value="discard" name="vote" />
              </div>
            </div>
        ...
        {members.map((element, index) => (
          ...
          >
            ...
            <div className="userVotes">
              {!isLoading ? (
                <MemberVotes value={memberChoiceMap.get(element.state.id)} />
              ) : (
                <p>Loading...</p>
              )}
            </div>
